# -------------------------------------------------------------------------
# @Description: brms phylogenetic SEM construction (national scale)
# -------------------------------------------------------------------------
...
checklist.csr.CHN.mrt <- checklist.csr %>%
  group_by(taxon_name, accepted_plant_name_id, invasion_status, TPL_names, c_score, s_score, r_score, wcup_eco_use_num, wcup_eco_use_num_2out) %>%
...
save(c_model_nat,
     ...
     s_model_ias,
     r_model_ias,
     file = "./results/csr.brm_phylo.sem_models.Rdata")
...
write_csv(model_nat.tidy02, "./results/phylo.sem.model_nat.tidy02.csv")
...
write_csv(model_ias.tidy02, "./results/phylo.sem.model_ias.tidy02.csv")
