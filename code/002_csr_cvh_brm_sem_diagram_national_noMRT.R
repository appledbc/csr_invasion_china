# -------------------------------------------------------------------------
# @Description: SEM diagram generation (national scale, without MRT)
# -------------------------------------------------------------------------
# Clear memory
cat("\014")
rm(list = ls())
...
# Load invasion data
# ==========================================================================
model_ias <- read.csv("./results/phylo.sem.model_ias.tidy02(AllSpWithoutMRT).csv")
model_ias
...
# ==========================================================================
model_nat <- read.csv("./results/phylo.sem.model_nat.tidy02(AllSpWithoutMRT).csv")
model_nat
...
ggexport(sem_models01, filename = "./results/sem_models01(AllSpWithoutMRT).png",
           width = 6000,
           height = 4000,
           pointsize = 12,
           res = 300)
